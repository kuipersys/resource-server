...
namespace Kuiper.Platform.Runtime.Execution
{
    ...
    public sealed class PlatformRuntimeExecutionContext : IInternalRuntimeExecutionContext
    {
        ...
        public PlatformRuntimeExecutionContext()
            : this(string.Empty)
        {
        }

        public PlatformRuntimeExecutionContext(string message, CancellationToken cancellationToken = default)
        {
        ...
        private PlatformRuntimeExecutionContext(CancellationToken cancellationToken = default)
        {
            this.ActivityId = Guid.NewGuid();
            this.CancellationToken = cancellationToken;
        }

        internal PlatformRuntimeExecutionContext(PlatformRequest request, CancellationToken cancellationToken = default)
        ...
        public IRuntimeExecutionContext? ParentContext { get; internal set; }
