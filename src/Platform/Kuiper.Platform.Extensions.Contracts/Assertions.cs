...
namespace Kuiper.Platform.Extensions.Contracts
{
    using System;
    ...
    public static class Assertions
    {
        ...
        public static void ThrowIfArgumentNull<TObject>(this TObject @object, string propertyName)
            => @object.ThrowIfNull(new ArgumentNullException(propertyName));
        ...
        public static void ThrowIfNotAssignableTo<TObject, TType>(this TObject @object, Exception exception = null)
            => @object.ThrowIfNotAssignableTo(typeof(TType), exception);
